...
| ALPHA-012 | Mini App App Shell + Chat UX | ALPHA-011 | Ready | `prs/alpha-012-mini-app-shell-chat-ux/brief.md` |
...
| ALPHA-012 | Mini App App Shell + Chat UX | ALPHA-011 | Ready | Chat-first layout, navigation, empty/loading/error states, locked states, thread refresh/retry, profile/access/support as secondary screens. |
