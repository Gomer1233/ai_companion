...
| --- | --- | --- | --- | --- |
| ALPHA-001 | Finish Refactor + Boundaries | None | Ready | `prs/alpha-001-refactor-boundaries/brief.md` |
| ALPHA-002 | FastAPI HTTP Adapter on Railway | ALPHA-001 | Planned | `prs/alpha-002-http-adapter/brief.md` |
| ALPHA-003 | Postgres Backend + Cutover Runbook | ALPHA-002 | Planned | `prs/alpha-003-postgres-cutover/brief.md` |
