...
- [ ] Add bot entry point for opening the Mini App.
- [ ] Add frontend and API integration tests.
- [ ] Add visual QA for mobile readability, reduced motion, access-state clarity, and absence of frontend-owned entitlement logic.
